...
const s = StyleSheet.create({
  ...
  backTxt:    { color: '#20C7B3', fontSize: 28, fontWeight: '300' },
  ...
  dateStr:    { color: '#4E677F', fontSize: 12 },
  rowInfo:    { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 },
  userRow:    { flex: 1 },
  roleLabel:  { color: '#4E677F', fontSize: 10, fontWeight: '700', letterSpacing: 0.5, marginBottom: 4 },
  username:   { color: '#E2E8F0', fontSize: 15, fontWeight: '600' },
  arrow:      { color: '#4E677F', fontSize: 18, marginHorizontal: 8 },
  detailBox:  { backgroundColor: '#0B1724', borderRadius: 10, padding: 12, marginBottom: 14 },
  detailTxt:  { color: '#94A3B8', fontSize: 13, fontStyle: 'italic', lineHeight: 18 },
  actions:    { flexDirection: 'row', gap: 8 },
  dismissBtn: { flex: 1, backgroundColor: '#102131', borderRadius: 10, paddingVertical: 11, alignItems: 'center', borderWidth: 1, borderColor: '#1B2F43' },
  ...
  emptyTxt:   { color: '#6D8298', fontSize: 15 },
})
...
const m = StyleSheet.create({
  ...
  input:      { backgroundColor: '#0B1724', borderWidth: 1.5, borderColor: '#1B2F43', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 13, color: '#F1F5F9', fontSize: 15, minHeight: 80, textAlignVertical: 'top', marginBottom: 16 },
